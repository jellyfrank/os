...
var core = openerp.web.core;
var ListView = openerp.web.ListView;
var QWeb = openerp.web.qweb;

openerp.st_dynamic_list = ListView.include({
    ...
    reload: function () {
       ...
       $('.oe_dropdown_btn').click(this.proxy('hide_show_columns'));
       $('.oe_dropdown_menu').click(this.proxy('stop_event'));
